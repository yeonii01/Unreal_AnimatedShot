...
// float hp = 6;
inline void PosInfo::clear_hp() {
  _impl_.hp_ = 0;
}
inline float PosInfo::_internal_hp() const {
  return _impl_.hp_;
}
inline float PosInfo::hp() const {
  // @@protoc_insertion_point(field_get:Protocol.PosInfo.hp)
  return _internal_hp();
}
inline void PosInfo::_internal_set_hp(float value) {
  
  _impl_.hp_ = value;
}
inline void PosInfo::set_hp(float value) {
  _internal_set_hp(value);
  // @@protoc_insertion_point(field_set:Protocol.PosInfo.hp)
}
